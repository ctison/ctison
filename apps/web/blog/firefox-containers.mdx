...
date: 2024-12-6
image: /blog/firefox.webp
tags: [firefox, privacy, web]
---

Firefox containers are a way to navigate the web from multiple browsing sessions in a single window. They unlock functionalities like:
